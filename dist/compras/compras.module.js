...
ComprasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([lancamentos_entity_1.Lancamentos, compra_entity_1.Compra])],
        controllers: [compras_controller_1.CompraController],
        providers: [compras_service_1.CompraService],
        exports: [compras_service_1.CompraService],
    })
], ComprasModule);
